# Container Action Template - ACCOUNT LEVEL
# ============================================================================
# Purpose: Comprehensive container action with all volume types
# Scope: No org_id, no project_id
# ============================================================================

resource "harness_chaos_action_template" "container_complex_volumes_account" {
  depends_on = [
...
output "action_template_account_id" {
  description = "ID of action template (account level)"
  value       = harness_chaos_action_template.container_complex_volumes_account.id
}

output "action_template_account_identity" {
  description = "Identity of action template (account level)"
  value       = harness_chaos_action_template.container_complex_volumes_account.identity
}
